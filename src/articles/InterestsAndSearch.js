export default function InterestsAndSearch ({ setArticleList }) {
  return (
    <div className='options' id='optionsID' style={{ display: 'inline-flex' }}>
      <br />
      <br />
      <br />
      <div className='interestButton'>
        <button type='button' className='orangeButton show-topic-subscriber'>
