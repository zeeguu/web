 ...
 */
 Zeeguu_API.prototype.loadUserInfo = function (userID, duration, callback) {
  ...
  Zeeguu_API.prototype.loadUserSessions = async function (userID, duration, callback) {
    let getBookmarks = await this.apiGet(`/cohort_member_bookmarks/${userID}/${duration}`)
