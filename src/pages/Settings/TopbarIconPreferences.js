...
export default function TopbarIconPreferences() {
  ...
  return (
    <CardPage layoutVariant={"minimalistic-top-aligned"}>
      <BackArrow />
      <Header withoutLogo>
      ...
      <Main>
        <FormSection>
          <IconRow>
            <Checkbox
              checked={whichItems.includes("exercisesTopBar")}
              onChange={(e) => handleIconPreferences(e, "exercisesTopBar")}
            />
            <AdjustedIcon>
              <NavIcon name="exercises" />
              <Description>{strings.exercisesThisWeek}</Description>
            </AdjustedIcon>
          </IconRow>
          <IconRow>
            <Checkbox
              checked={whichItems.includes("articleMinutesTopBar")}
              onChange={(e) => handleIconPreferences(e, "articleMinutesTopBar")}
            />
            <AdjustedIcon>
          ...
          <IconRow>
            <Checkbox
              checked={whichItems.includes("streakTopBar")}
              onChange={(e) => handleIconPreferences(e, "streakTopBar")}
            />
            <AdjustedIcon>
