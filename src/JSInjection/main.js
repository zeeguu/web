...
import { cleanAfterArray, cleanIndividualDocument } from "./Cleaning/pageSpecificClean";
...
export function Main() {
  ...
  let cleanedContent = cleanIndividualDocument(article.content, url, cleanAfterArray);
