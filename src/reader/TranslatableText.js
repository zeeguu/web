...
import { removePunctuation, removePunctuationFollowedBySpace } from "../utils/preprocessing/preprocessing";
...
export function TranslatableText({
  ...
  function renderWordJSX(word) {
    ...
    const isBoldWord = boldWords.includes(removePunctuationFollowedBySpace(word.word));
    ...
    if (isCorrect) {
      ...
      const translationExercise = exerciseType === exerciseTypes.translateWhatYouHear && exerciseType === exerciseTypes.multipleChoice;
