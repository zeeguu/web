...
let strings = new LocalizedStrings(
  {
    en: {
      ...
      exercises: "Exercise",
      verbalFlashcards: "Train speech",
      verbalFlashcardsTitle: "Verbal Flashcards",
      verbalFlashcardsLowNoise: "Low Noise (Indoor)",
      verbalFlashcardsMediumNoise: "Medium Noise (Outdoor)",
      verbalFlashcardsHighNoise: "High Noise (Street)",
      verbalFlashcardsNoiseSensitivityUpdated: "Sensitivity updated",
      verbalFlashcardsProgress: "Progress:",
      verbalFlashcardsScore: "Score:",
      verbalFlashcardsStreak: "Streak:",
      verbalFlashcardsLoading: "Loading flashcards...",
      verbalFlashcardsNoCards: "No flashcards available.",
      verbalFlashcardsSayThis: "Say this:",
      verbalFlashcardsYourAttempt: "Your attempt:",
      verbalFlashcardsNoSpeechDetected: "No speech detected",
      verbalFlashcardsAccuracy: "Accuracy:",
      verbalFlashcardsWordBreakdown: "Word breakdown:",
      verbalFlashcardsPrevious: "← Previous",
      verbalFlashcardsNext: "Next →",
      verbalFlashcardsShuffleCards: "Shuffle cards",
      verbalFlashcardsRepeatThisCard: "Repeat this card",
      verbalFlashcardsPlayingTtsAudio: "Playing TTS audio...",
      verbalFlashcardsNoTextAvailableForTts: "No text available for TTS",
      verbalFlashcardsRequestingTtsAudio: "Requesting TTS audio...",
      verbalFlashcardsTtsReturnedNoAudioPath: "TTS returned no audio path",
      verbalFlashcardsSpokenPromptFinished: "Spoken prompt finished",
      verbalFlashcardsTtsAudioPlaybackFailed: "TTS audio playback failed",
      verbalFlashcardsTtsRequestFailed: "TTS request failed",
      verbalFlashcardsPlayingFeedback: "Playing feedback...",
      verbalFlashcardsPlayingAnswer: "Playing answer...",
      verbalFlashcardsCouldNotSaveResult: "Could not save result",
      verbalFlashcardsGetReadyToTryAgain: "Get ready to try again...",
      verbalFlashcardsRetryingSameCard: "Retrying the same card...",
      verbalFlashcardsProcessing: "Processing...",
      verbalFlashcardsRecordingCancelled: "Recording cancelled",
      verbalFlashcardsNoFlashcardLoaded: "Error: No flashcard loaded",
      verbalFlashcardsNoAudioDetected: "No audio detected",
      verbalFlashcardsErrorPrefix: "Error",
      verbalFlashcardsCouldNotEvaluatePronunciation: "Could not evaluate pronunciation. Please try again.",
      verbalFlashcardsRecordingSpeakNow: "Recording... Speak now",
      verbalFlashcardsWaitingForSpeech: "Waiting for speech / silence...",
      verbalFlashcardsMicAnalysisError: "Mic analysis error",
      verbalFlashcardsMicrophonePermissionNeeded: "Microphone permission needed",
      verbalFlashcardsListenCarefully: "Listen carefully...",
      verbalFlashcardsStartingMicrophone: "Starting microphone...",
      dailyAudio: "Listen",
      translate: "Translate",
      today: "Today",
    ...
    da: {
      ...
      verbalFlashcardsTitle: "Udtale flashcards",
      verbalFlashcardsLowNoise: "Lav støj (indendørs)",
      verbalFlashcardsMediumNoise: "Mellem støj (udendørs)",
      verbalFlashcardsHighNoise: "Høj støj",
      verbalFlashcardsNoiseSensitivityUpdated: "Følsomhed opdateret",
      verbalFlashcardsProgress: "Fremskridt:",
      verbalFlashcardsScore: "Score:",
      verbalFlashcardsStreak: "Streak:",
      verbalFlashcardsLoading: "Indlæser flashcards...",
      verbalFlashcardsNoCards: "Ingen flashcards tilgængelige.",
      verbalFlashcardsSayThis: "Sig dette:",
      verbalFlashcardsYourAttempt: "Dit forsøg:",
      verbalFlashcardsNoSpeechDetected: "Ingen tale registreret",
      verbalFlashcardsAccuracy: "Nøjagtighed:",
      verbalFlashcardsWordBreakdown: "Ordopdeling:",
      verbalFlashcardsPrevious: "← Forrige",
      verbalFlashcardsNext: "Næste →",
      verbalFlashcardsShuffleCards: "Bland kort",
      verbalFlashcardsRepeatThisCard: "Gentag dette kort",
      verbalFlashcardsPlayingTtsAudio: "Afspiller tale...",
      verbalFlashcardsNoTextAvailableForTts: "Ingen tekst tilgængelig til tale",
      verbalFlashcardsRequestingTtsAudio: "Henter tale...",
      verbalFlashcardsTtsReturnedNoAudioPath: "Taleafspillingen returnerede ingen lydsti",
      verbalFlashcardsSpokenPromptFinished: "Oplæsningen er færdig",
      verbalFlashcardsTtsAudioPlaybackFailed: "Afspilning af tale mislykkedes",
      verbalFlashcardsTtsRequestFailed: "Hentning af tale mislykkedes",
      verbalFlashcardsPlayingFeedback: "Afspiller feedback...",
      verbalFlashcardsPlayingAnswer: "Afspiller svar...",
      verbalFlashcardsCouldNotSaveResult: "Kunne ikke gemme resultat",
      verbalFlashcardsGetReadyToTryAgain: "Gør dig klar til at prøve igen...",
      verbalFlashcardsRetryingSameCard: "Prøver det samme kort igen...",
      verbalFlashcardsProcessing: "Behandler...",
      verbalFlashcardsRecordingCancelled: "Optagelsen blev annulleret",
      verbalFlashcardsNoFlashcardLoaded: "Fejl: Intet flashcard er indlæst",
      verbalFlashcardsNoAudioDetected: "Ingen lyd registreret",
      verbalFlashcardsErrorPrefix: "Fejl",
      verbalFlashcardsCouldNotEvaluatePronunciation: "Kunne ikke vurdere udtalen. Prøv igen.",
      verbalFlashcardsRecordingSpeakNow: "Optager... Tal nu",
      verbalFlashcardsWaitingForSpeech: "Venter på tale / stilhed...",
      verbalFlashcardsMicAnalysisError: "Fejl ved mikrofonanalyse",
      verbalFlashcardsMicrophonePermissionNeeded: "Mikrofontilladelse nødvendig",
      verbalFlashcardsListenCarefully: "Lyt godt efter...",
      verbalFlashcardsStartingMicrophone: "Starter mikrofon...",
      code: "Kode",
      interest: "interesse",
