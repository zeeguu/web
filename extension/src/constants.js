...
export const NO_INTERNET_CONNECTION =
  "Zeeguu couldn't access the URL, check your internet connection.";
export const API_DOWN_FEEDBACK =
  "The Zeeguu Server is not responding, try again later.";
export const LANGUAGE_FEEDBACK = "This language is not supported yet";
export const READABILITY_FEEDBACK = "This text is not readable";
export const SESSISON_FEEDBACK =
